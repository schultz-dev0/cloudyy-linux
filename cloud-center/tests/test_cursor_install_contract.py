...
SOURCE_CURSOR = REPO_ROOT / "install/assets/defaults/hypr/cursor.lua"
SOURCE_VARIABLES = REPO_ROOT / "install/assets/defaults/hypr/variables.lua"
DEPENDENCIES = REPO_ROOT / "install/packages/manifest.sh"
