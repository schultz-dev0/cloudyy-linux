...
LAUNCH_PATHS = [
    ...
    REPO_ROOT / "install/user/desktop-entries.sh",
    REPO_ROOT / "cloud-center/cc-restart.sh",
    REPO_ROOT / ".config/quickshell/cloud-center/shell.qml",
    REPO_ROOT / ".config/quickshell/cloud-center/components/RowButton.qml",
]
DEBUG_SCRIPT = REPO_ROOT / "cloud-center/cc-debug.sh"
...
class GtkLaunchCutoverTests(unittest.TestCase):
    ...
    def test_debug_script_launches_qml_wrapper(self):
        ...
        self.assertIn('LAUNCHER="$HOME/cloudyy-linux/cloud-center/cloud-center"', source)
