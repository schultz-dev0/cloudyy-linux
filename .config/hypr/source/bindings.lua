...
hl.bind(
	mainMod .. " + SHIFT + B",
	hl.dsp.exec_cmd(browser .. " --new-window"),
	{ desc = "Open browser" }
)
hl.bind(
	mainMod .. " + SHIFT + M",
	hl.dsp.exec_cmd("uwsm-app spotify"),
	{ desc = "Open Spotify" }
)
hl.bind(
	mainMod .. " + SHIFT + O",
	hl.dsp.exec_cmd("uwsm-app obs"),
	{ desc = "Open OBS" }
)
...
hl.bind(
	"SHIFT + Print",
	hl.dsp.exec_cmd("hyprcap shot region -z -w"),
	{ desc = "Screenshot region and save" }
)
hl.bind(
	"Print",
...
hl.bind(
	mainMod .. " + Print",
	hl.dsp.exec_cmd("hyprpicker -a || pkill hyprpicker"),
	{ desc = "Colour picker" }
)
hl.bind(
	mainMod .. " + SHIFT + W",
...
hl.bind(
	mainMod .. " + SHIFT + N",
	hl.dsp.exec_cmd("qs ipc call notifs dnd"),
	{ desc = "Toggle DND" }
)
hl.bind(
	mainMod .. " + CTRL + N",
	hl.dsp.exec_cmd("qs ipc call notifs clearAll"),
...
hl.bind(
	mainMod .. " + SHIFT + T",
	hl.dsp.exec_cmd("quickshell ipc call timer toggle"),
	{ desc = "Toggle timer panel" }
)
hl.bind(
	mainMod .. " + SHIFT + C",
	hl.dsp.exec_cmd("quickshell ipc call calendar toggle"),
...
hl.bind(
	...
	{ repeating = true, desc = "Focus left" }
)
hl.bind(
	mainMod .. " + SHIFT + right",
...
hl.bind(
	...
	{ repeating = true, desc = "Focus up" }
)
hl.bind(
	mainMod .. " + SHIFT + down",
	hl.dsp.focus({ direction = "down" }),
	{ repeating = true, desc = "Focus down" }
)
hl.bind(
	mainMod .. " + CTRL + left",
...
hl.bind(
	"XF86LaunchA",
	hl.dsp.exec_cmd("qs ipc call spotlight command"),
	{ locked = true, desc = "Command Center" }
)
