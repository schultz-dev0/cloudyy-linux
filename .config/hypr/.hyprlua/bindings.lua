...
hl.bind("ALT + 2", hl.dsp.exec_cmd("uwsm-app -- " .. scripts .. "/cloud-center --bluetooth"),
    { desc = "Bluetooth Manager" })
hl.bind("ALT + 3", hl.dsp.exec_cmd("uwsm-app -- " .. scripts .. "/cloud-center --audio"), { desc = "Audio Mixer" })
hl.bind("ALT + 4", hl.dsp.exec_cmd("uwsm-app python3 " .. scripts .. "/cloud-center-v2/cloud-center.py"),
    { desc = "Cloud Center" })
hl.bind("ALT + 6", hl.dsp.exec_cmd("pkill -x visinput || " .. scripts .. "/cloudyy-other/visinput"),
...
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(scripts .. "/theme_controller.sh toggle"),
    { desc = "Toggle light/dark theme" })

-- ── Volume (laptop keys) ──────────────────────────────────────────────────────

hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(scripts .. "/sliders/volume-slider.sh up"),
    { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(scripts .. "/sliders/volume-slider.sh down"),
    { locked = true, repeating = true })
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(scripts .. "/sliders/brightness-slider.sh up"),
    { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(scripts .. "/sliders/brightness-slider.sh down"),
    { locked = true, repeating = true })
...
hl.bind(mainMod .. " + CTRL + Space", hl.dsp.exec_cmd("uwsm-app cliphist list | rofi -dmenu | cliphist decode | wl-copy"),
    { desc = "Open clipboard history" })
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(os.getenv("HOME") .. "/cloudyy_scripts/clipboard/clipboard.sh copy"),
    { desc = "Universal copy" })
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd(os.getenv("HOME") .. "/cloudyy_scripts/clipboard/clipboard.sh paste"),
...
hl.bind(mainMod .. "+ SHIFT + E", hl.dsp.exec_cmd("~/cloudyy_scripts/clipboard/text_extract.sh"),
