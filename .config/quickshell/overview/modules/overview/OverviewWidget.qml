    ...
    Rectangle { // Background
        ...
        ColumnLayout { // Workspaces
                ...
                Repeater {
                    ...
                    Repeater { // Workspace repeater
                        ...
                        Rectangle { // Workspace
                            ...
                            property color hoveredWorkspaceColor: ColorUtils.mix(defaultWorkspaceColor, Appearance.colors.colLayer1Hover, 0.05)
                            ...
                            color: showWallpaper ? "transparent" : ColorUtils.applyAlpha(
                                root.glassMode
                                    ? ColorUtils.mix(hoveredWhileDragging ? hoveredWorkspaceColor : defaultWorkspaceColor, Appearance.colors.colLayer0, 0.55)
                            ...
                            Rectangle {
                                ...
                                color: "transparent"
                                border.width: 1
                                border.color: ColorUtils.applyAlpha("#FFFFFF", root.glassBorderOpacity * 0.10)
                            }

                            StyledText {
                                anchors.centerIn: parent
                                visible: !workspace.showWallpaper && !root.workspaceHasWindows(workspaceValue)
                                text: workspaceValue
                                font {
                                ...
                                color: ColorUtils.applyAlpha(Appearance.colors.colOnLayer1, 0.15)
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: ColorUtils.applyAlpha(
                        root.glassMode
                            ? ColorUtils.mix(Appearance.colors.colLayer0, Appearance.colors.colLayer1, 0.75)
                            : Appearance.colors.colLayer1,
                        root.glassMode ? Math.min(0.65, root.effectivePanelOpacity) : root.effectiveWorkspaceOpacity
                    )
                    border.width: 1
                    border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer2Border, root.glassMode ? root.glassBorderOpacity * 0.4 : 0.45)
                    ...
                    Rectangle {
                        ...
                        radius: parent.radius
                        color: ColorUtils.applyAlpha(Appearance.colors.colSecondary, root.glassMode ? 0.08 : 0.05)
                    }
                    ...
                    StyledText {
                        ...
                        anchors.topMargin: root.specialStripPadding * 0.8
                        text: "Special Workspaces"
                        font.family: Appearance.font.family.title
                        font.pixelSize: root.specialStripTitleHeight * 0.9
                    ...
                    Grid {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                border.width: 1
                                border.color: ColorUtils.applyAlpha(Appearance.colors.colLayer2Border, root.glassMode ? root.glassBorderOpacity * 0.4 : 0.55)
                        ...
                        Rectangle {
                            ...
                            color: showWallpaper ? "transparent" : ColorUtils.applyAlpha(
                                root.glassMode
                                    ? ColorUtils.mix(Appearance.colors.colSecondaryContainer, Appearance.colors.colLayer1, 0.65)
                                    : ColorUtils.mix(Appearance.colors.colLayer2, Appearance.colors.colLayer1, 0.60),
                                root.draggingTargetSpecialWorkspace === root.createSpecialWorkspaceTarget ? 0.85 : root.effectiveWorkspaceOpacity
                            )
                            border.width: 1
                            border.color: root.draggingTargetSpecialWorkspace === root.createSpecialWorkspaceTarget
                                ? ColorUtils.applyAlpha(root.activeBorderColor, 0.85)
                                : ColorUtils.applyAlpha(Appearance.colors.colSecondary, 0.35)
                            ...
                            Rectangle {
                                ...
                                color: "transparent"
                                border.width: 1
                                border.color: ColorUtils.applyAlpha("#FFFFFF", root.glassMode ? 0.10 : 0.05)
                            }
                            ...
                            Column {
                                ...
                                StyledText {
                                    ...
                                    font.pixelSize: root.draggingTargetSpecialWorkspace === root.createSpecialWorkspaceTarget
                                        ...
                                        : Appearance.font.pixelSize.huge * 1.15 * root.scale
                                    font.weight: Font.DemiBold
                                    color: ColorUtils.applyAlpha(Appearance.colors.colOnLayer1, 0.80)
                                    horizontalAlignment: Text.AlignHCenter
                                }
                            }
        ...
        Item { // Windows & focused workspace indicator
            ...
            Rectangle { // Focused workspace indicator
                ...
                opacity: panelWindow.focusedSpecialWorkspace !== "" ? 0.3 : 0.8
