...
PanelWindow {
    ...
    margins { top: topGap; left: sideGap; right: sideGap }
    ...
    function launch(cmd) {
        const p = procProto.createObject(bar, { command: cmd })
        p.running = true
    }
    ...
    component Pill: Rectangle {
        ...
        property color  bg:       Qt.rgba(Theme.surface_container.r,
        ...
        MouseArea {
            ...
            onWheel: e => { e.angleDelta.y > 0 ? pill.scrollUp() : pill.scrollDown() }
            onEntered: if (pill.hoverable) pill.color = Qt.rgba(
                Theme.surface_container_high.r,
                Theme.surface_container_high.g,
                Theme.surface_container_high.b, 0.9)
    ...
    Rectangle {
        id: barBg
        anchors { top: parent.top; topMargin: bar.topGap; left: parent.left; right: parent.right }
        ...
        Row {
            ...
            Pill {
                ...
                Timer { interval: 10000; running: true; repeat: true; onTriggered: clockPill.t = Qt.formatDateTime(new Date(), "hh:mm") }
            ...
            Pill {
                ...
                Process {
                    ...
                    stdout: SplitParser { onRead: d => updatesPill.n = d.trim() }
                }
            }
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            color: focused
                                ...
                                : (empty
                                    ? Qt.rgba(Theme.surface_container_high.r, Theme.surface_container_high.g, Theme.surface_container_high.b, 0.18)
        ...
        Row {
            ...
            Pill {
                ...
                Process {
                    ...
                    stdout: SplitParser { onRead: d => memPill.lbl = "󰘚 " + d.trim() + "%" }
                }
            }
            ...
            Pill {
                ...
                label: {
                    if (full)     return "󰁹 Full"
                    if (charging) return "󰂄 " + Math.round(pct) + "%"
                ...
                fg: charging || full ? Theme.tertiary
                    : (pct < 15 ? Theme.on_error_container : Theme.on_surface)
                bg: charging || full
